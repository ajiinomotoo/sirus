...
@section('container')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Non-Medis/</span> Job</h4>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('body').on('click', '.editJob', function() {
                ...
                // alert(kasir_id);
                $.get("{{ route('job.index') }}" + '/' + job_id + '/edit', function(data) {
