...
@section('container')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Medis/</span> Rawat Jalan &#40;Online&#41; </h4>
...
@push('scriptbody')
    ...
    <script type="text/javascript">
        $(function() {
            $("#nik_bpjs").blur(function() {
                var reg_no = $('#reg_no').val();
                // alert(reg_no);
                var nik_bpjs = $(this).val();
                // alert(nik_bpjs);
                $.ajax({
                    url: "{{ route('autofillrjonline') }}",
                    data: {
                        reg_no: reg_no,
                        nik_bpjs: nik_bpjs
                    },
