...
<head>
    ...
    {{-- STEP COBA --}}
    {{-- <link rel="stylesheet" href="/assets/css/multistep/multistep.css"> --}}

    <style type="text/css">
        /* Adjust the height of section */
        #rjForm .content-wrapper {
            min-height: 100px;
        }

        #rjForm .content-wrapper>.body {
            width: 100%;
            height: auto;
            padding: 15px;
            position: relative;
...
<body>
            ...
            <div class="bgcard card col-lg-12 my-5">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <form id="rjFormStep" name="rjFormStep">
                            <div>
                                {{-- Step 1 --}}
                                <h2>Registrasi</h2>
                                <section>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="reg_no" name="reg_no"
                                                placeholder="Masukkan No. Registrasi" class="required">
                                        </div>
                                    </div>
                                </section>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="fa-solid fa-id-card"
                                                        disabled></i></span>
                                                <input type="datetime-local" class="form-control" id="rj_date_step2"
                                        ...
                                        <div class="group-form-kiri col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="reg_no_step2"
                                        ...
                                        <div class="group-form-kanan col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select select2-klaim" name="klaim_id_step2"
                                                    id="klaim_id_step2" style="width:100%;">
    ...
    {{-- SCRIPT COBA --}}
    <script src="/assets/js/multistep/multistep.js"></script>


    <!-- End Core JS -->

    {{-- Text JS --}}
    {{-- Funtion Autocomplete, Insert --}}
