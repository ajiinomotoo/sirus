...
class RstxnRjhdrsOnlineController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('medis.rjonline', compact('rstxn_rjhdrs'), [
            'polis' => rsmstPoli::all(),
            'doctors' => rsmstDoctor::all(),
            'klaims' => rsmstKlaimType::all(),
            'noRj' => RstxnRjhdrsOnlineController::myRjno(),
            'autodate' => RstxnRjhdrsOnlineController::autodate()
        ]);
    }
